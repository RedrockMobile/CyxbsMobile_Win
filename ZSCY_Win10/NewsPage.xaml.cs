...
namespace ZSCY_Win10
{
    ...
    public sealed partial class NewsPage : Page
    {
        ...
        private async void initJWList(int page = 0)
        {
                        ...
                        if (Newsitem.Title != null)
                        {
                            ...
                            if (newsContent != "")
                            {
                                ...
                                if (Int32.Parse(newsContentobj["state"].ToString()) == 200)
                                {
                                    ...
                                    //content.Replace(" ", "");
                                    Debug.WriteLine("content->" + content);
                                    JWList.Add(new NewsList { Title = Newsitem.Title, Date = Newsitem.Date, Read = Newsitem.Read, Content = content, Content_all = content_all, ID = Newsitem.ID });
                                }
                            }
