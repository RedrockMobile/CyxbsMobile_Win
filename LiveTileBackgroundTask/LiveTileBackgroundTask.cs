...
namespace LiveTileBackgroundTask
{
    public sealed class LiveTileBackgroundTask : IBackgroundTask
    {
        ...
        private List<KeyValuePair<string, string>> curriculumParamList = new List<KeyValuePair<string, string>>();
        private List<KeyValuePair<string, string>> transactionParamList = new List<KeyValuePair<string, string>>();
